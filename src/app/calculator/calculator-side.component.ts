...
import { DrillTimeSpeedCalculatorComponent } from "./drill-calculator/time-speed/drill-time-speed-calculator.component";
...
@Component({
  ...
  standalone: true,
  imports: [HeaderComponent, DrillTimeSpeedCalculatorComponent, MixerCalculatorComponent, BulkProcessingCalculatorComponent, PressCalculatorComponent, MillstoneCalculatorComponent, CrushingCalculatorComponent, BeltCalculatorComponent, RouterOutlet],
